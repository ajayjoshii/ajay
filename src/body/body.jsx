            ...
            <div className="body-main">
                <div className="intro">
                    ...
                    <div className='action'>
                        ...
                        <CustomButton onClick={()=>console.log ('body hire me clicked')} id="download" isdownload colorClass="btn-style2" title="Download CV"></CustomButton>
                    </div>
                </div>
